...
d.video_0 ! queue ! h264parse ! avdec_h264  ! glimagesink \
d.audio_0 ! queue ! aacparse ! faad ! audioconvert ! alsasink

gst-launch-1.0 -e \
souphttpsrc location=http://users.datasciencelab.ugent.be/MM/tears_of_steel_720p.mp4 ! qtdemux name=d \
d.video_0 ! queue ! h264parse ! avdec_h264  ! glimagesink \
d.audio_0 ! queue ! mpegaudioparse ! mpg123audiodec ! audioconvert ! alsasink